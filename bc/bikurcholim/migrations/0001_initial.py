    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_date', models.DateTimeField(default=None, verbose_name=b'open date')),
                ('date_of_service', models.DateTimeField(default=None, verbose_name=b'service date')),
                ('close_date', models.DateTimeField(default=None, verbose_name=b'close date')),
