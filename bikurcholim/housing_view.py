...
def getCols():
    ...
    cols['id']={
        ...
        'format': "<a href='/bikurcholim/housingschedule/{0}' class='userId' target='_blank'>{0}</a>",  #Used to format the data anything you want. Use {0} as placeholder for the actual data.
